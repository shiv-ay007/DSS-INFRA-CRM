...
// Initial dataset matching real business leads
const initialScheduledLeads = [
  ...
  },
  {
    ...
    followupHistory: [
      { date: "Tomorrow", time: "10:00 am", notes: "Share stage curvature drawings and truss loading report.", rep: "Sales TL", status: "Tomorrow" }
    ],
  ...
  },
  {
    ...
    followupRemarksCount: 1,
    followupHistory: [
      { date: "Tomorrow", time: "05:17 pm", notes: "Discussion on stainless steel 3D letter lighting and warranty.", rep: "Sales TL", status: "Tomorrow" }
    ],
  ...
  {
    id: "LD-SCH-07",
    concernPersonName: "Ananya Deshmukh",
    ...
    followupRemarksCount: 2,
    followupHistory: [
      { date: "28 Aug 2026", time: "12:10 pm", notes: "Boardroom installation demo for 85-inch UHD smart display.", rep: "Sales TL", status: "Completed" }
    ],
