...
const AddContractorComponent = () => {
  ...
  return (
    <div className="space-y-4 pb-12 px-1 sm:px-2 font-sans">
      {/* Top Header */}
      <div className="sticky top-0 z-40 bg-gradient-to-r from-blue-900 via-indigo-950 to-slate-900 text-white rounded-xl px-4 py-2.5 shadow-md border border-blue-700/50">
